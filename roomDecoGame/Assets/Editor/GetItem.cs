...
public class GetItem : MonoBehaviour
{
    ...
    private string furnitureColorCode = "255255255255";
    private string patternColorCode = "255255255255";
    ...
    private void SetFurnitureColor()
    {
        ...
        furnitureColorCode = r.ToString() + g.ToString() + b.ToString() + a.ToString();
    ...
    private void SetPatternColor()
    {
        ...
        patternColorCode = r.ToString() + g.ToString() + b.ToString() + a.ToString();
